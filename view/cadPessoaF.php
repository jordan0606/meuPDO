...
<html>
    ...
    <body>
        ...
        <form action="<?php $cadPessoaF->inserirBD(); ?>" method="POST">
            ...
            <br><br>
            <input type="tel" required placeholder="Telefone aqui..." minlength="11" maxlength="11" 
                   name="telefone">
            <br><br>
            ...
            <br><br>
            <input type="text" placeholder="CPF aqui..." minlength="11" maxlength="11" name="cpf"
                   name="cpf" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');"/>
            <br><br>
